    ...
    return (
        <>
            <li className='icon-wrapper'>
                <a className='nav-icon-links' target="_blank" href='https://github.com/jxw7410/yuutubu'>
            ...
            <li className='icon-wrapper'>
                <a className='nav-icon-links' target="_blank" href='https://www.linkedin.com/in/jian-hong-wu-b1535284/'>
...

            {
                props.type === 'main' ? null :
                    <li className='icon-wrapper'>
                        <a className='nav-icon-links' target="_blank" href='https://angel.co/jian-wu-12?public_profile=1'>
