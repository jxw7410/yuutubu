...
class MainSideNavType2 extends React.Component {
    constructor(props) {
        super(props)
        this.state = {
            readMore: false,
    ...
    render() {
        ...
        return (
            <>
                <div id={'main-side-nav-ctn-type-2' + (this.props.toggled ? "" : "-toggled")}>
                ...
                <div id={'main-side-nav-ctn-screen' + (this.props.toggled ? "" : "-toggled")}
...
export default withRouter(MainSideNavType2)